...
Fazer um programa para ler o caminho de um arquivo `.csv` contendo os dados de itens vendidos. Cada item possui um nome, preço unitário e quantidade, separados por vírgula. 
